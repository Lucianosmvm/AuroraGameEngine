...
namespace CaminhosDaFe.Droid;

// Paisagem fixa: o jogo é autorado em 1280x720. Nas telas mais largas que 16:9 sobram barras
// escuras nas laterais (Game.DesignResolution faz o letterbox).
[Activity(Label = "Caminhos da Fé", MainLauncher = true,
    ConfigurationChanges = ConfigChanges.Orientation | ConfigChanges.ScreenSize | ConfigChanges.KeyboardHidden,
    ScreenOrientation = ScreenOrientation.Landscape)]
public class MainActivity : SilkActivity
{
    private volatile CaminhosDaFe.CaminhosGame? _game;
    ...
    protected override void OnRun()
    {
        ...
        using var game = new CaminhosDaFe.CaminhosGame();
        _game = game;
